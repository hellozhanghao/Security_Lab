...
def search():
    ...
    return render_template('main.html', name=session['username'][0],
                           error="Search not implemented yet. Could not find " + term, news=getNews())
...
def name():
    ...
    return render_template('main.html', name=session['username'][0], error2="Updated username to " + name,
                           news=getNews())
